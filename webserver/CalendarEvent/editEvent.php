...
$editTitle  = trim(filter_input(INPUT_POST, 'title'));
$editDate   = filter_input(INPUT_POST, 'edit_date');
$editLocation = trim(filter_input(INPUT_POST, 'location'));
$editDescription  = trim(filter_input(INPUT_POST, 'description'));
